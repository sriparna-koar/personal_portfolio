...
// import { AppBar, Toolbar, Typography, IconButton, Box, useScrollTrigger } from '@mui/material';
// import { Home, Work, ContactMail, AccountCircle } from '@mui/icons-material';
...
//     { label: 'Portfolio', icon: <Work />, href: '#portfolio' },
//     { label: 'Skills', icon: <AccountCircle />, href: '#skills' },
//     { label: 'Projects', icon: <Build />, href: '#projects' },
